...
| GOV-8 | The laws — sortable/filterable explorer, cost, vote, enactment date | done | done | Shipped | #3, #31 | contracts/interfaces/law-data.md, contracts/interfaces/charts.md, contracts/interfaces/budget-data.md |

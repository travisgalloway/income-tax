...
| ECO-5 | `test_wage_and_profit_share_are_gdp_shares_and_do_not_sum_to_100`, `test_fy2020_share_moves_are_denominator_artefacts` | `npx astro check`, `npm run build` | same M1-M4 gap as the other Economy-route figures, unexecuted | no automated JS coverage of `LaborAndCapital.tsx`'s interaction |
